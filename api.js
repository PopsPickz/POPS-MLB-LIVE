const API = {
  ...
  */
  ...
  async getBvPStats(
    ...
    /*
    No season parameter is included here.

    This allows the request to retrieve career
    batter-vs-pitcher history instead of only
    the current season.
    */
    const url =
      `${this.base}/people/` +
